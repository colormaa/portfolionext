                        ...
                        <div className="relative p-4 mb-3 w-full max-w-2xl h-full  ">
                            <div className="relative bg-white mb-2 rounded-lg bg-white-700">
                                ...
                                <div className="flex items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                                    ...
                                    <button type="button" className="text-green-500 bg-white hover:bg-green-200 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-green-200 text-sm font-medium px-5 py-2.5 hover:text-green-600 focus:z-10 ">View</button>
                                </div>
                            </div>
                        </div>
                    </div>
